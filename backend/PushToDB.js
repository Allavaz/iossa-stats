        ...
        fs.readFile(item.path, (err, data) => {
            try {
                ...
                if (json.matchData == undefined) {
                    ...
                    let month = item.name.slice(5, 7);
                    let day = item.name.slice(8, 10);
                    let hour = item.name.slice(11, 13);
                    let minute = item.name.slice(15, 17);
                    let second = item.name.slice(19, 21);
