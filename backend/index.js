...
app.get("/api/teams/:id/:torneo", (req, res) => {
  rdb.getTeamStatsFromID(req.params.id, req.params.torneo, res);
});

app.get("/api/teamsplayers/:id/:torneo", (req, res) => {
  rdb.getTeamPlayersFromID(req.params.id, req.params.torneo, res);
});
