			...
			<div style={{display: 'flex', padding: '10px', justifyContent: 'center', flexWrap: 'wrap', alignItems: 'center'}}>
				<div style={{display: 'flex', flexGrow: 1, maxWidth: '328px', marginBottom: '10px'}}>
					...
					<div>
						...
						<div style={{color: 'var(--header-color)', marginTop: '5px'}}><img height='16px' src={getTeamLogo(statsAll.team)} alt={statsAll.team} style={{verticalAlign: 'text-top', marginRight: '0.25ch'}}></img> {statsAll.team}</div>
