...
export default function MatchRow({ match }: { match: Match }) {
  return (
    ...
    >
      <div
        className="flex w-[32%] items-center justify-end gap-x-1 rounded-l-lg border border-neutral-200 p-3 dark:border-neutral-700"
        title={match.teams[0].teamname}
      >
      ...
      <div className="flex w-[60px] shrink-0 items-center justify-center border-y border-r p-2 dark:border-neutral-700">
      ...
      <div
        className="flex w-[32%] items-center gap-x-1 border-y border-r p-3 dark:border-neutral-700"
        title={match.teams[1].teamname}
      >
        <img
          className="h-6"
