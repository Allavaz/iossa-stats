...
import { faTwitch, faInstagram, faYoutube, faDiscord, faTiktok } from '@fortawesome/free-brands-svg-icons';
          ...
          <tbody>
            <tr>
              {socials.map((item, index) => (
                <td key={index}><a href={item.link} target='_blank' rel='noopener noreferrer'><FontAwesomeIcon icon={item.icon}></FontAwesomeIcon></a></td>
              ))}
            </tr>
          </tbody>
        </table>
