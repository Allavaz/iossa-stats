module.exports = {
  ...
  t7: {
    $or: [
      ...
      { torneo: "Liga D2 T7" },
      { torneo: "Liga D2 T7 (Desempate Campeon)" },
      { torneo: "Liga D1 T7" },
  ...
  t8: {
    $or: [
      { torneo: "Superliga D1 T8" },
      { torneo: "Copa valencARc T8" },
      { torneo: "Liga Zero T8 - Grupo A" },
      { torneo: "Liga Zero T8 - Grupo B" },
      { torneo: "Liga Zero T8 - Playoff" }
    ]
  },
  t9: {
    $or: [
      { torneo: "Liga D1 T9" },
      { torneo: "Liga D2 T9" },
      { torneo: "Liga D2 T9 (Desempate Campeon)" },
      { torneo: "Liga D3 T9" },
      { torneo: "Copa valencARc T9" },
      { torneo: "Copa Maradei T9 - Eliminatorias" },
      { torneo: "Copa Maradei T9 - Grupo A" },
      { torneo: "Copa Maradei T9 - Grupo B" },
      { torneo: "Copa Maradei T9 - Grupo C" },
      { torneo: "Copa Maradei T9 - Grupo D" },
      { torneo: "Copa Maradei T9 (Desempate 3er Mejor)"}
    ]
  },
  selecciones: {
    $or: [
  ...
  d1t2: {
    $or: [{ torneo: "Liga D1 T2" }, { torneo: "Liga D1 T2 (Desempate)" }]
  },
  d1t1: {
