function getRegex(arg) {
  ...
  if (tempregex.test(arg)) {
    ...
    return { $regex: "Liga D1" };
  } else if (arg === "d2") {
    return { $regex: "Liga D2" };
  } else if (arg === "d3") {
    return { $regex: "Liga D3" };
  } else if (arg === "master") {
