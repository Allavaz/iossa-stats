			...
			<div style={{display: 'flex', padding: '10px', justifyContent: 'center', flexWrap: 'wrap', alignItems: 'center'}}>
				<div style={{display: 'flex', flexGrow: 1, maxWidth: '330px', marginBottom: '10px'}}>
					...
					<div>
						...
						<div style={{marginTop: '5px', color: 'rgb(90,90,90', display: props.data.name === props.steaminfo.personaname ? 'none' : 'block'}}>{props.steaminfo.personaname}</div>
						...
						<div style={{marginTop: '10px', color: 'rgb(90,90,90', fontSize: '0.75em'}}>{props.data.matches} partidos</div>
						...
						<div style={{marginTop: '5px', color: 'rgb(90,90,90', fontSize: '0.75em'}}>{`${props.data.losses} derrota${props.data.wins > 1 ? 's' : ''}`}</div>
					</div>
				</div>
